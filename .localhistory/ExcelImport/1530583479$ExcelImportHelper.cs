                ...
                foreach (PropertyInfo Prty in PropertyInfos)
                {
                    ...
                    if (PrtyExeclMapping != null && dt.Columns.Contains(PrtyExeclMapping.ExeclHeadName))
                    {
                        ...
                        if (value != DBNull.Value && value != null && !string.IsNullOrEmpty(value.ToString()))
                        {
                            ...
                            ExcelBaseValidationAttribute[] baseValidationAttributeArray = CacheHelper.GetCache<ExcelBaseValidationAttribute[]>(BaseValidationPropertyKey);
                            ...
                            {
                                baseValidationAttributeArray = Prty.GetCustomAttributes(typeof(ExcelBaseValidationAttribute),true);
