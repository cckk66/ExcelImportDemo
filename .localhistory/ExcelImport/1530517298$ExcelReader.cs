...
namespace ExcelImport
{
    public class ExcelReader
    {
        ...
        internal (string[] headArr, DataTable dt) ReaderExcel(string filepath) => this.ReaderExcel(filepath, "");
        internal (string[] headArr, DataTable dt) ReaderExcel(string filepath, string sheetName)
        {
